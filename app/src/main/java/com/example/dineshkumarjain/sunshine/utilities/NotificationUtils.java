...
import com.example.dineshkumarjain.sunshine.DetailsActivity;
import com.example.dineshkumarjain.sunshine.R;
    ...
    */
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
             ...
             */
            SunshinePreference.saveLastNotificationTime(context, System.currentTimeMillis());
        }
