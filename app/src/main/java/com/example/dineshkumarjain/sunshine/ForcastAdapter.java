...
import com.example.dineshkumarjain.sunshine.utilities.SunshineDateUtils;
import com.example.dineshkumarjain.sunshine.utilities.SunshineWeatherUtils;

/**
 * Created by Dinesh kumar jain on 10-03-2018.
 */

public class ForcastAdapter  extends RecyclerView.Adapter<ForcastAdapter.ForecastAdapterViewHolder> {
     ...
     */
    public ForcastAdapter(@NonNull Context context, ForecastAdapterOnClickHandler clickHandler) {
        mContext = context;
