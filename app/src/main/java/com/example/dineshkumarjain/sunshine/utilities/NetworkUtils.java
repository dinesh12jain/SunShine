package com.example.dineshkumarjain.sunshine.utilities;
...
/**
 * Created by Dinesh kumar jain on 09-03-2018.
 */
...
public final class NetworkUtils {
    ...
    public static URL getUrl(Context context) {
        if (SunshinePreference.isLocationLatLonAvailable(context)) {
            double[] preferredCoordinates = SunshinePreference.getLocationCoordinates(context);
            double latitude = preferredCoordinates[0];
            double longitude = preferredCoordinates[1];
            return buildUrlWithLatitudeLongitude(latitude, longitude);
        } else {
            String locationQuery = SunshinePreference.getPreferredWeatherLocation(context);
